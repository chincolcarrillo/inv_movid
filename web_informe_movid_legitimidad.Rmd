---
title: |
  | ![](input/images/logo_facso.png){width=2.5in} \linebreak  \linebreak \linebreak  
  |
  | "Gobernanza en Crisis Sanitaria: Un análisis sobre la legitimidad de las medidas sanitarias adoptadas por el Gobierno de Chile"  \linebreak   \linebreak   
subtitle: "Investigación realizada en el marco del curso Estadística Multivariada, dictado por Juan Carlos Castillo en el Departamento de Sociología de la Universidad de Chile" 
author: | 
 | Vicente Campos Aparicio, Carolina Carrillo Devia, Javier González Ortiz,
 | Matías Martini Serrano y Maru Meléndez Berndt   
date: "06/07/2021"
...
htmlreg(l = list(m00,m01,or1,m05,or5,m08,or8), 
       ...
       caption = "**Tabla 2.** /linebreak  _Modelos de regresión logística (selección)_",
       caption.above = T,
       inline.css	= T,
       center = F)
